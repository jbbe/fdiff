...
module Shell =
    ...
    type State =
        ...
        { aboutState: About.State; diffState: Diff.DiffState }
    ...
    let init =
        ...
        let diffState = Diff.init
        { aboutState = aboutState; diffState = diffState },
    ...
    let update (msg: Msg) (state: State): State * Cmd<_> =
        ...
        | DiffMsg diffmsg ->
            let diffMsg =
                Diff.update diffmsg state.diffState
            { state with diffState = diffMsg },
            /// map the message to the kind of message 
            /// your child control needs to handle
            Cmd.none
                ...
                [ TabControl.create
                    [ TabControl.tabStripPlacement Dock.Top
                      TabControl.viewItems
                          [ TabItem.create
                                [ TabItem.header "Diff"
                                  TabItem.content (Diff.view state.diffState (DiffMsg >> dispatch)) ]
                            TabItem.create
